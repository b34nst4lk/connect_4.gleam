...
-file("src/birdie/internal/titles.gleam", 220).
?DOC(false).
...
-file("src/birdie/internal/titles.gleam", 344).
?DOC(false).
...
-file("src/birdie/internal/titles.gleam", 369).
?DOC(false).
...
-file("src/birdie/internal/titles.gleam", 230).
?DOC(false).
...
snap_call(Birdie_import, Expression) ->
    case Expression of
        ...
        {call, Function, [{unlabelled_field, _}, {unlabelled_field, Title}]} ->
            Is_snap_function = is_snap_function(Function, Birdie_import),
            gleam@bool:guard(
                not Is_snap_function,
                {error, nil},
        ...
        {call, Function, [{labelled_field, <<"title"/utf8>>, Title}, _]} ->
            Is_snap_function = is_snap_function(Function, Birdie_import),
            gleam@bool:guard(
                not Is_snap_function,
                {error, nil},
        ...
        {binary_operator,
            pipe,
            Title,
            {call, Function, [{labelled_field, <<"content"/utf8>>, _}]}} ->
            Is_snap_function = is_snap_function(Function, Birdie_import),
            gleam@bool:guard(
                not Is_snap_function,
                {error, nil},
        ...
        {binary_operator,
            pipe,
            _,
            {call, Function, [{unlabelled_field, Title}]}} ->
            Is_snap_function = is_snap_function(Function, Birdie_import),
            gleam@bool:guard(
                not Is_snap_function,
                {error, nil},
        ...
        {binary_operator,
            pipe,
            _,
            {call, Function, [{labelled_field, <<"title"/utf8>>, Title}]}} ->
            Is_snap_function = is_snap_function(Function, Birdie_import),
            gleam@bool:guard(
                not Is_snap_function,
                {error, nil},
        ...
        {binary_operator,
            pipe,
            Title,
            {fn_capture, _, Function, [{unlabelled_field, _}], []}} ->
            Is_snap_function = is_snap_function(Function, Birdie_import),
            gleam@bool:guard(
                not Is_snap_function,
                {error, nil},
...
-file("src/birdie/internal/titles.gleam", 515).
?DOC(false).
-spec try_or({ok, KLM} | {error, any()}, KLQ, fun((KLM) -> KLQ)) -> KLQ.
...
-file("src/birdie/internal/titles.gleam", 522).
?DOC(false).
-spec 'try'(
    {ok, KLR} | {error, KLS},
    fun((KLS) -> KLV),
    fun((KLR) -> {ok, KLW} | {error, KLV})
) -> {ok, KLW} | {error, KLV}.
...
-file("src/birdie/internal/titles.gleam", 398).
?DOC(false).
-spec try_fold_expression(
    glance:expression(),
    KKK,
    fun((KKK, glance:expression()) -> {ok, KKK} | {error, KKL})
) -> {ok, KKK} | {error, KKL}.
...
-file("src/birdie/internal/titles.gleam", 385).
?DOC(false).
-spec try_fold_statements(
    list(glance:statement()),
    KKE,
    fun((KKE, glance:expression()) -> {ok, KKE} | {error, KKF})
) -> {ok, KKE} | {error, KKF}.
...
-file("src/birdie/internal/titles.gleam", 475).
?DOC(false).
-spec try_fold_fields(
    list(glance:field(glance:expression())),
    KKS,
    fun((KKS, glance:expression()) -> {ok, KKS} | {error, KKT})
) -> {ok, KKS} | {error, KKT}.
...
-file("src/birdie/internal/titles.gleam", 488).
?DOC(false).
-spec try_fold_clauses(
    list(glance:clause()),
    KKZ,
    fun((KKZ, glance:expression()) -> {ok, KKZ} | {error, KLA})
) -> {ok, KKZ} | {error, KLA}.
...
-file("src/birdie/internal/titles.gleam", 504).
?DOC(false).
-spec try_fold_expressions(
    list(glance:expression()),
    KLG,
    fun((KLG, glance:expression()) -> {ok, KLG} | {error, KLH})
) -> {ok, KLG} | {error, KLH}.
