...
-type occurs(KCJ) :: {one, integer(), list(KCJ), list(KCJ)} |
    {other, integer(), list(KCJ), list(KCJ)} |
    {both, integer(), list(KCJ), list(KCJ), list(KCJ), list(KCJ)}.
...
?DOC(false).
-spec sum_occurrences(occurs(KDQ), occurs(KDQ)) -> occurs(KDQ).
...
?DOC(false).
-spec histogram_add(
    gleam@dict:dict(KDE, occurs(KDE)),
    list(KDE),
    fun((integer(), list(KDE), list(KDE)) -> occurs(KDE)),
    list(KDE)
) -> gleam@dict:dict(KDE, occurs(KDE)).
...
?DOC(false).
-spec lowest_occurrence_common_item(list(KCW), list(KCW)) -> gleam@option:option({KCW,
    integer(),
    list(KCW),
    list(KCW),
    list(KCW),
...
?DOC(false).
-spec do_pop_common_prefix(list(KEA), list(KEA), list(KEA)) -> {list(KEA),
    list(KEA),
    list(KEA)}.
...
?DOC(false).
-spec pop_common_prefix(list(KDU), list(KDU)) -> {list(KDU),
    list(KDU),
    list(KDU)}.
...
?DOC(false).
-spec pop_common_suffix(list(KEH), list(KEH)) -> {list(KEH),
    list(KEH),
    list(KEH)}.
...
?DOC(false).
-spec lcs(list(KCS), list(KCS)) -> list(KCS).
lcs(One, Other) ->
    ...
    case lowest_occurrence_common_item(One@2, Other@2) of
        none ->
            gleam@list:flatten([Prefix, Suffix]);
