...
-file("/Users/amanning/code/mist/src/mist/internal/http2/stream.gleam", 147).
-spec make_request(
    list({binary(), binary()}),
...
-file("/Users/amanning/code/mist/src/mist/internal/http2/stream.gleam", 56).
-spec new(
...
-file("/Users/amanning/code/mist/src/mist/internal/http2/stream.gleam", 200).
