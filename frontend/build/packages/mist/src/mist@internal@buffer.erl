...
-file("/Users/amanning/code/mist/src/mist/internal/buffer.gleam", 8).
-spec empty() -> buffer().
empty() ->
    {buffer, 0, <<>>}.

-file("/Users/amanning/code/mist/src/mist/internal/buffer.gleam", 12).
-spec new(bitstring()) -> buffer().
new(Data) ->
    {buffer, 0, Data}.

-file("/Users/amanning/code/mist/src/mist/internal/buffer.gleam", 16).
...
-file("/Users/amanning/code/mist/src/mist/internal/buffer.gleam", 22).
...
-file("/Users/amanning/code/mist/src/mist/internal/buffer.gleam", 30).
-spec with_capacity(buffer(), integer()) -> buffer().
with_capacity(Buffer, Size) ->
    _record = Buffer,
    {buffer, Size, erlang:element(3, _record)}.

-file("/Users/amanning/code/mist/src/mist/internal/buffer.gleam", 34).
