...
-file("/Users/amanning/code/mist/src/mist/internal/telemetry.gleam", 67).
-spec log(
    list(event()),
...
-file("/Users/amanning/code/mist/src/mist/internal/telemetry.gleam", 89).
-spec span(
    list(event()),
    gleam@dict:dict(binary(), gleam@dynamic:dynamic_()),
    fun(() -> QCH)
...
-file("/Users/amanning/code/mist/src/mist/internal/telemetry.gleam", 106).
-spec attach_many(
    binary(),
    list(list(event())),
...
-file("/Users/amanning/code/mist/src/mist/internal/telemetry.gleam", 135).
-spec attach(
    binary(),
    list(event()),
    fun((list(event()), gleam@dict:dict(gleam@erlang@atom:atom_(), gleam@dynamic:dynamic_()), gleam@dict:dict(binary(), gleam@dynamic:dynamic_()), list(any())) -> nil),
...
-file("/Users/amanning/code/mist/src/mist/internal/telemetry.gleam", 148).
