...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/utils.gleam", 6).
-spec term_width() -> integer().
term_width() ->
    _pipe = term_size:columns(),
    gleam@result:unwrap(_pipe, 80).

-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/utils.gleam", 66).
-spec do_shorten(
    list(binary()),
    list(binary()),
    boolean(),
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/utils.gleam", 31).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/utils.gleam", 11).
