...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 70).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 81).
-spec init_socket(
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 96).
-spec loop_socket(
    {gleam@erlang@process:subject(socket_msg()),
        gleam@erlang@process:subject(watcher_msg())},
    mist@internal@websocket:websocket_connection(),
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 133).
-spec close_socket(
    {gleam@erlang@process:subject(socket_msg()),
        gleam@erlang@process:subject(watcher_msg())}
) -> nil.
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 197).
-spec loop_watcher(
    watcher_msg(),
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 269).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 253).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 152).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 139).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server/live_reload.gleam", 54).
