...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 411).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 430).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 449).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 368).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 390).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 441).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 400).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 419).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 378).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 490).
-spec string_dict(
    fun((gleam@dynamic:dynamic_()) -> {ok, MTT} |
        {error, list(gleam@dynamic:decode_error())})
) -> fun((gleam@dynamic:dynamic_()) -> {ok, gleam@dict:dict(binary(), MTT)} |
    {error, list(gleam@dynamic:decode_error())}).
string_dict(Values) ->
    gleam@dynamic:dict(fun gleam@dynamic:string/1, Values).

-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 357).
...
-file("/Users/louis/src/gleam/package-interface/src/gleam/package_interface.gleam", 347).
