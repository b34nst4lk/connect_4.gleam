...
?DOC(false).
-spec add_date_header(gleam@http@response:response(RJC)) -> gleam@http@response:response(RJC).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(RJF)) -> gleam@http@response:response(RJF).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(RJI)) -> gleam@http@response:response(RJI).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(RJL)) -> gleam@http@response:response(RJL).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(RJQ)) -> gleam@http@response:response(RJQ)).
