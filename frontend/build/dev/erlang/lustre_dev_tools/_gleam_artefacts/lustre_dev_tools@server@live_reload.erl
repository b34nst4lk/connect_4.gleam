...
-file("src/lustre_dev_tools/server/live_reload.gleam", 70).
?DOC(false).
...
-file("src/lustre_dev_tools/server/live_reload.gleam", 81).
?DOC(false).
-spec init_socket(
...
-file("src/lustre_dev_tools/server/live_reload.gleam", 96).
?DOC(false).
-spec loop_socket(
    {gleam@erlang@process:subject(socket_msg()),
        gleam@erlang@process:subject(watcher_msg())},
...
-file("src/lustre_dev_tools/server/live_reload.gleam", 133).
?DOC(false).
-spec close_socket(
    {gleam@erlang@process:subject(socket_msg()),
        gleam@erlang@process:subject(watcher_msg())}
...
-file("src/lustre_dev_tools/server/live_reload.gleam", 197).
?DOC(false).
-spec loop_watcher(
    watcher_msg(),
...
-file("src/lustre_dev_tools/server/live_reload.gleam", 269).
?DOC(false).
...
-file("src/lustre_dev_tools/server/live_reload.gleam", 253).
?DOC(false).
...
-file("src/lustre_dev_tools/server/live_reload.gleam", 139).
?DOC(false).
...
-file("src/lustre_dev_tools/server/live_reload.gleam", 54).
?DOC(false).
