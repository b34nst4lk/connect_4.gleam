...
-export([esbuild_os/0, esbuild_cpu/0, tailwind_os/0, tailwind_cpu/0, minify/0, tailwind_entry/0, outdir/0, ext/0, detect_tailwind/0, port/0, proxy_from/0, proxy_to/0, entry/0]).
