...
-type repeater(USL) :: any() | {gleam_phantom, USL}.
...
-spec call(integer(), USM, fun((USM, integer()) -> USM)) -> repeater(USM).
...
-spec set_function(repeater(USQ), fun((USQ, integer()) -> USQ)) -> nil.
...
-spec update_state(repeater(USU), fun((USU) -> USU)) -> nil.
...
-spec set_state(repeater(USS), USS) -> nil.
