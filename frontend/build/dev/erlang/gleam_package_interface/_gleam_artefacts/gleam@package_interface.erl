...
-file("src/gleam/package_interface.gleam", 411).
...
-file("src/gleam/package_interface.gleam", 430).
...
-file("src/gleam/package_interface.gleam", 449).
...
-file("src/gleam/package_interface.gleam", 368).
...
-file("src/gleam/package_interface.gleam", 390).
...
-file("src/gleam/package_interface.gleam", 441).
...
-file("src/gleam/package_interface.gleam", 400).
...
-file("src/gleam/package_interface.gleam", 419).
...
-file("src/gleam/package_interface.gleam", 378).
...
-file("src/gleam/package_interface.gleam", 490).
-spec string_dict(
    fun((gleam@dynamic:dynamic_()) -> {ok, FYM} |
        {error, list(gleam@dynamic:decode_error())})
) -> fun((gleam@dynamic:dynamic_()) -> {ok, gleam@dict:dict(binary(), FYM)} |
    {error, list(gleam@dynamic:decode_error())}).
string_dict(Values) ->
    gleam@dynamic:dict(fun gleam@dynamic:string/1, Values).

-file("src/gleam/package_interface.gleam", 357).
...
-file("src/gleam/package_interface.gleam", 347).
