...
-type pool(KIB, KIC) :: {pool,
        fun((glisten@internal@handler:loop_message(KIB), KIC, glisten@internal@handler:connection(KIB)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(KIB), KIC)),
        integer(),
        fun((glisten@internal@handler:connection(KIB)) -> {KIC,
            gleam@option:option(gleam@erlang@process:selector(KIB))}),
        gleam@option:option(fun((KIC) -> nil)),
        glisten@transport:transport()}.
