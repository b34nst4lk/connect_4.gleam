...
-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 30).
-spec default_settings() -> http2_settings().
default_settings() ->
    {http2_settings, 4096, disabled, 100, 65535, 16384, none}.

-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 41).
...
-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 93).
-spec send_data(
...
-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 115).
-spec send_frame(
...
-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 154).
-spec hpack_new_context(integer()) -> hpack_context().
hpack_new_context(Size) ->
    hpack:new_context(Size).

-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 157).
...
-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 165).
...
-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 171).
...
-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 62).
-spec send_headers(
    hpack_context(),
    mist@internal@http:connection(),
    list({binary(), binary()}),
...
-file("/Users/amanning/code/mist/src/mist/internal/http2.gleam", 125).
