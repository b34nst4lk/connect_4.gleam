...
-opaque builder(PGE, PGF) :: {builder,
        integer(),
        fun((gleam@http@request:request(PGE)) -> gleam@http@response:response(PGF)),
...
-type websocket_message(PGG) :: {text, binary()} |
    {binary, bitstring()} |
    closed |
    shutdown |
    {custom, PGG}.
...
-file("/Users/amanning/code/mist/src/mist.gleam", 60).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 67).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 56).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 79).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 115).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 129).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 159).
-spec read_body(
...
-file("/Users/amanning/code/mist/src/mist.gleam", 188).
-spec do_stream(
    gleam@http@request:request(mist@internal@http:connection()),
    mist@internal@buffer:buffer()
) -> fun((integer()) -> {ok, chunk()} | {error, read_error()}).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 253).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 233).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 305).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 356).
-spec new(
    fun((gleam@http@request:request(PHD)) -> gleam@http@response:response(PHF))
) -> builder(PHD, PHF).
new(Handler) ->
    {builder,
        4000,
...
-file("/Users/amanning/code/mist/src/mist.gleam", 380).
-spec port(builder(PHJ, PHK), integer()) -> builder(PHJ, PHK).
port(Builder, Port) ->
    _record = Builder,
    {builder,
        Port,
...
-file("/Users/amanning/code/mist/src/mist.gleam", 387).
-spec read_request_body(
    builder(bitstring(), PHP),
    integer(),
    gleam@http@response:response(PHP)
) -> builder(mist@internal@http:connection(), PHP).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 409).
-spec after_start(
    builder(PHV, PHW),
    fun((integer(), gleam@http:scheme(), ip_address()) -> nil)
) -> builder(PHV, PHW).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 420).
-spec bind(builder(PIB, PIC), binary()) -> builder(PIB, PIC).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 429).
-spec with_ipv6(builder(PIH, PII)) -> builder(PIH, PII).
with_ipv6(Builder) ->
    _record = Builder,
    {builder,
        erlang:element(2, _record),
...
-file("/Users/amanning/code/mist/src/mist.gleam", 433).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 459).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 463).
-spec get_port(server()) -> integer().
get_port(Server) ->
    erlang:element(3, Server).

-file("/Users/amanning/code/mist/src/mist.gleam", 478).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 468).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 545).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 533).
-spec start_https(
    builder(mist@internal@http:connection(), response_data()),
    binary(),
    binary()
...
-file("/Users/amanning/code/mist/src/mist.gleam", 599).
-spec internal_to_public_ws_message(
    mist@internal@websocket:handler_message(PJI)
) -> {ok, websocket_message(PJI)} | {error, nil}.
...
-file("/Users/amanning/code/mist/src/mist.gleam", 624).
-spec websocket(
    gleam@http@request:request(mist@internal@http:connection()),
    fun((PJO, mist@internal@websocket:websocket_connection(), websocket_message(PJP)) -> gleam@otp@actor:next(PJP, PJO)),
    fun((mist@internal@websocket:websocket_connection()) -> {PJO,
        gleam@option:option(gleam@erlang@process:selector(PJP))}),
    fun((PJO) -> nil)
...
-file("/Users/amanning/code/mist/src/mist.gleam", 677).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 701).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 745).
-spec event(gleam@string_tree:string_tree()) -> sse_event().
event(Data) ->
    {sse_event, none, none, none, Data}.

-file("/Users/amanning/code/mist/src/mist.gleam", 750).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 755).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 760).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 773).
-spec server_sent_events(
    gleam@http@request:request(mist@internal@http:connection()),
    gleam@http@response:response(any()),
    fun(() -> gleam@otp@actor:init_result(PKD, PKE)),
    fun((PKE, sse_connection(), PKD) -> gleam@otp@actor:next(PKE, PKD))
) -> gleam@http@response:response(response_data()).
...
-file("/Users/amanning/code/mist/src/mist.gleam", 818).
