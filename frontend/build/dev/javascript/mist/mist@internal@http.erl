...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 77).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 112).
-spec read_data(
    glisten@socket:socket(),
    glisten@transport:transport(),
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 239).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 515).
-spec add_date_header(gleam@http@response:response(MWK)) -> gleam@http@response:response(MWK).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 522).
-spec connection_close(gleam@http@response:response(MWN)) -> gleam@http@response:response(MWN).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 526).
-spec keep_alive(gleam@http@response:response(MWQ)) -> gleam@http@response:response(MWQ).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 530).
-spec maybe_keep_alive(gleam@http@response:response(MWT)) -> gleam@http@response:response(MWT).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 537).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 547).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(MWY)) -> gleam@http@response:response(MWY)).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 567).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 596).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 604).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 83).
-spec parse_headers(
    bitstring(),
    glisten@socket:socket(),
    glisten@transport:transport(),
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 625).
-spec crypto_hash(sha_hash(), binary()) -> binary().
crypto_hash(Hash, Data) ->
    crypto:hash(Hash, Data).

-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 628).
-spec base64_encode(binary()) -> binary().
base64_encode(Data) ->
    base64:encode(Data).

-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 145).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 252).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 175).
-spec read_chunk(
    glisten@socket:socket(),
    glisten@transport:transport(),
    mist@internal@buffer:buffer(),
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 362).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 445).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 452).
...
-file("/Users/amanning/code/mist/src/mist/internal/http.gleam", 492).
-spec upgrade(
    glisten@socket:socket(),
    glisten@transport:transport(),
    list(binary()),
