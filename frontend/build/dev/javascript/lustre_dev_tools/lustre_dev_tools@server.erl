...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server.gleam", 79).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server.gleam", 72).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/server.gleam", 24).
-spec start(binary(), integer()) -> lustre_dev_tools@cli:cli(nil).
start(Entry, Port) ->
