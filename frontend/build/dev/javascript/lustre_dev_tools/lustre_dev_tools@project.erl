...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 38).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 51).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 100).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 96).
-spec root() -> binary().
root() ->
    find_root(<<"."/utf8>>).

-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 75).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 109).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 162).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 154).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 168).
-spec string_dict(
    fun((gleam@dynamic:dynamic_()) -> {ok, ADPQ} |
        {error, list(gleam@dynamic:decode_error())})
) -> fun((gleam@dynamic:dynamic_()) -> {ok, gleam@dict:dict(binary(), ADPQ)} |
    {error, list(gleam@dynamic:decode_error())}).
string_dict(Values) ->
    gleam@dynamic:dict(fun gleam@dynamic:string/1, Values).

-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 143).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 134).
...
-file("/home/runner/work/dev-tools/dev-tools/src/lustre_dev_tools/project.gleam", 57).
...
interface() ->
    ...
    gleam@result:'try'(
        ...
        fun(_) ->
            ...
            _assert_subject@1 = gleam@json:decode(Json, fun interface_decoder/1),
