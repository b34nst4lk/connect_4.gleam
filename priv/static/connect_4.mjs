...
var LustreClientApplication = class _LustreClientApplication {
  ...
  static start({ init: init2, update: update2, view }, selector, flags) {
    ...
    const app = new _LustreClientApplication(root, init2(flags), update2, view);
   ...
   */
  constructor(root, [init2, effects], update2, view) {
    this.root = root;
    this.#model = init2;
    this.#update = update2;
    this.#view = view;
...
var LustreServerApplication = class _LustreServerApplication {
  static start({ init: init2, update: update2, view, on_attribute_change }, flags) {
...
function simple(init2, update2, view) {
  let init$1 = (flags) => {
...
function main() {
  let app = simple(new$4, update, game);
